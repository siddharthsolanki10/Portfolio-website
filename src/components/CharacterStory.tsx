...
export const CharacterStory: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-32 md:py-64 bg-zinc-950 overflow-hidden"
    >
      <div className="container mx-auto px-8 relative z-10 flex flex-col items-center text-center">
        <div className="story-line mb-8">
          <h2 className="text-zinc-500 font-inter text-xs tracking-[0.5em] uppercase mb-4">
            Ahmedabad, Gujarat
          </h2>
          <h1 className="text-5xl md:text-8xl font-cinzel text-white tracking-widest mb-4">
            SIDDHARTH SOLANKI
          </h1>
          <p className="text-orange-500 font-inter text-sm tracking-[0.3em] uppercase">
            Backend Developer (Intern) • Node.js • NestJS • MongoDB • SQL
          </p>
        </div>
        ...
        <div className="story-line mb-16 max-w-xl">
          <p className="text-2xl md:text-3xl italic text-zinc-300 font-serif">
            "Not born with privilege. Built through failure."
          </p>
        </div>

        <div className="story-line mb-16 max-w-xl">
          <p className="text-2xl md:text-3xl italic text-zinc-300 font-serif">
            "Shaped by persistence in the quiet hours of the night."
          </p>
        </div>
        ...
        <div className="story-line mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-zinc-500 font-inter tracking-[0.2em] text-[10px] uppercase">
          <div>4 Major Projects</div>
          <div>1 Year Backend Exp.</div>
