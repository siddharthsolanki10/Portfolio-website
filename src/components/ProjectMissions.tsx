...
const missions = [
  {
    ...
    title: "Kidolio",
    subtitle:
      "Family Learning & Records Platform with TypeScript, React, and modern backend infrastructure.",
    status: "MISSION COMPLETED (LIVE)",
    type: "completed-live",
    image:
      "https://images.unsplash.com/photo-1516321318423-f06a6b1ef6bc?q=80&w=1200&auto=format&fit=crop",
  },
  {
    id: "02",
    title: "YouTube Clone",
    subtitle:
      "Full-stack video platform backend with REST APIs, real-time features, and Cloudinary integration.",
  ...
  {
    id: "03",
    title: "E-Commerce Backend (ShopVerse)",
    subtitle:
      "Production-ready e-commerce API with JWT auth, RBAC, Redis caching, and real-time observability.",
    status: "MISSION COMPLETED",
    type: "completed",
    image:
  ...
  },
  {
    ...
    title: "Twitter Clone",
    subtitle:
      "Full-stack social platform with Appwrite backend, real-time engagement, and modern frontend.",
    ...
    <section className="bg-[#0a0a0c] py-64 overflow-hidden relative">
      <div className="container mx-auto px-8 relative z-10">
        <div className="text-center mb-48">
          <p className="text-orange-500 font-inter text-[10px] tracking-[0.8em] uppercase mb-4 opacity-60">
            The Portfolio
          </p>
          <h2 className="text-white font-cinzel text-5xl md:text-7xl mb-4 tracking-[0.2em]">
            MISSIONS
          </h2>
...
const MissionItem: React.FC<{ mission: any; index: number }> = ({
  mission,
  index,
}) => {
  ...
  const getStatusIcon = () => {
    ...
    if (mission.type === "progress")
      return <Target size={14} className="animate-spin-slow" />;
  ...
  return (
    <div
      ref={containerRef}
      className={`flex flex-col ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} gap-16 items-center relative group`}
    >
      {/* Visual Asset */}
      ...
      <div className="w-full md:w-2/5 flex flex-col justify-center">
        <div className="mission-text-reveal space-y-6">
          <div className="flex items-center gap-4">
            ...
            <span className="text-orange-500 font-inter text-[10px] tracking-[0.5em] uppercase">
              JOURNAL ENTRY {mission.id}
            </span>
          </div>
          ...
          <div className="pt-8 flex flex-wrap gap-4">
            ...
            <div
              className={`inline-flex items-center gap-3 px-6 py-3 border backdrop-blur-md transition-all duration-500 group-hover:shadow-[0_0_20px_rgba(0,0,0,0.5)] ${getStatusColor()}`}
            >
              <div className="relative">
                <div
                  className={`absolute inset-0 blur-sm opacity-50 ${mission.type.includes("completed") ? "bg-current" : ""} animate-pulse`}
                ></div>
                {getStatusIcon()}
              </div>
