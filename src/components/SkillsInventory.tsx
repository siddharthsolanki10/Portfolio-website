...
const skills = [
  {
    ...
    symbol: "The Forge",
    icon: <Zap size={48} />,
    desc: "Building dynamic, interactive UIs with component-driven architecture and modern React patterns.",
  },
  {
    name: "Node.js",
    symbol: "The Engine",
    icon: <Cpu size={48} />,
    desc: "Forging robust backend APIs and server-side logic for production environments.",
  },
  {
    name: "NestJS",
    symbol: "The Framework",
    icon: <Layers size={48} />,
    desc: "Building scalable and maintainable backend architectures with enterprise-grade patterns.",
  },
  {
    name: "Express.js",
    symbol: "The Router",
    icon: <Target size={48} />,
    desc: "Lightweight and powerful HTTP server framework for rapid API development.",
  },
  {
    name: "Tailwind CSS",
    symbol: "The Armor",
    icon: <Palette size={48} />,
    desc: "Utility-first CSS framework for rapid UI development with precision and scalability.",
  },
  {
    name: "TypeScript",
    symbol: "The Shield",
    icon: <Shield size={48} />,
    desc: "Type-safe development across full-stack applications ensuring code reliability and maintainability.",
  },
  {
    name: "MongoDB",
    symbol: "The Vault",
    icon: <Database size={48} />,
    desc: "NoSQL database expertise for flexible, document-based data storage at scale.",
  },
  {
    name: "SQL",
    symbol: "The Ledger",
    icon: <Layout size={48} />,
    desc: "Relational database design and optimization for structured data management.",
  },
  {
    name: "JWT & Authentication",
    symbol: "The Guardian",
    icon: <Lock size={48} />,
    desc: "Secure authentication and RBAC/ABAC authorization for full-stack applications.",
  },
  {
    name: "Docker",
    symbol: "The Container",
    icon: <Cloud size={48} />,
    desc: "Containerization and deployment for consistent environments across development and production.",
  },
  {
    name: "AWS & DevOps",
    symbol: "The Cloud",
    icon: <Cpu size={48} />,
    desc: "Cloud infrastructure, monitoring, and observability with Grafana and modern deployment tools.",
  },
];
    ...
    const timer = setTimeout(() => {
      let ctx = gsap.context(() => {
        ...
        masterTl.to(
          ...
          "-=0.2",
        ); // Start slighty before reveal ends for cinematic flow
      }, containerRef);
  ...
  return (
    ...
    >
      <div className="px-12 mb-8 z-30">
        <h2 className="text-zinc-600 font-inter text-xs tracking-[0.5em] uppercase mb-2">
          Inventory
        </h2>
        <h3 className="text-3xl md:text-5xl font-cinzel text-white tracking-widest">
          Tools of the Trade
        </h3>
      </div>
